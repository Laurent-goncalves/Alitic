...
import com.g.laurent.alitic.Controllers.ChronoFragment
...
class ChronoActivity : AppCompatActivity(), OnTimeLineDisplay {
    ...
    override fun displayTimeLine(day: Int, month: Int, year: Int) {
...
interface OnTimeLineDisplay {
    fun displayTimeLine(day:Int, month:Int, year:Int)
}